...
class HomomorphicFilterDialog(QDialog):
    def __init__(self, parent, apply_callback):
        ...
        self.cutoff_slider.valueChanged.connect(lambda: self.cutoff_label.setText(f"Cutoff: {self.cutoff_slider.value()}"))
...
class MedianFilterDialog(QDialog):
    def __init__(self, parent, apply_callback):
        ...
        self.ksize_slider.valueChanged.connect(lambda: self.ksize_label.setText(f"Kernel size: {self.ksize_slider.value()}"))
...
class ShockFilterDialog(QDialog):
    def __init__(self, parent, apply_callback):
        ...
        self.iterations_slider.valueChanged.connect(lambda: self.iterations_label.setText(f"Iterazioni: {self.iterations_slider.value()}"))
...
class MeanFilterDialog(QDialog):
    def __init__(self, parent, apply_callback):
        ...
        self.kernel_size_slider.valueChanged.connect(lambda: self.kernel_size_label.setText(f"Kernel Size: {self.kernel_size_slider.value()}"))
